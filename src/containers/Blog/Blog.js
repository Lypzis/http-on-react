                ...
                <header>
                    <nav>
                        <ul className="Blog__nav-list">
                            <li className="Blog__nav-list-item"><Link to="/" className="Blog__nav-link">Home</Link></li>
                            <li className="Blog__nav-list-item"><Link to={
                                {
                                    pathname: '/new-post',
                                    hash: '#submit',
                                    search: '?quick-submit=true'
                                }
                            } className="Blog__nav-link">New Post</Link></li>
                        </ul>
                    </nav>
                </header>
